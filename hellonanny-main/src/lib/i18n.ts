    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          period: "one-time",
          features: [
            "Temporary or vacation coverage",
      ...
      plans: [
        {
          ...
          currency: "฿",
          period: "一次性",
          features: ["兼职保姆或家政", "灵活排班", "预筛选候选人", "在线面试支持"],
        },
        {
          name: "全职",
          price: "7,800",
        ...
        },
        {
          ...
          currency: "฿",
          period: "一次性",
          features: ["临时或假期覆盖", "短期任务", "预筛选候选人", "快速匹配"],
        },
      ],
    },
    airtable: {
      ...
      plans: [
        {
          ...
          period: "ครั้งเดียว",
          features: [
            "พี่เลี้ยงหรือแม่บ้านพาร์ทไทม์",
            "ตารางเวลายืดหยุ่น",
            "ผู้สมัครผ่านการคัดกรอง",
            "สนับสนุนสัมภาษณ์ออนไลน์",
          ],
        },
        {
          name: "ฟูลไทม์",
          ...
          popular: true,
          features: [
            "พี่เลี้ยงหรือแม่บ้านฟูลไทม์",
            "เลือกอยู่ประจำหรือไป-กลับได้",
            "ผู้สมัครผ่านการคัดกรอง",
            "สนับสนุนสัมภาษณ์ออนไลน์",
            "รับประกันเปลี่ยนตัว",
          ],
