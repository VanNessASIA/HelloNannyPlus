                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <a
                      ...
                      className="flex items-center gap-4 p-4 bg-[#06C755]/10 rounded-2xl hover:bg-[#06C755]/20 transition-colors group"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 p-4 bg-[#25D366]/10 rounded-2xl hover:bg-[#25D366]/20 transition-colors group"
                    >
